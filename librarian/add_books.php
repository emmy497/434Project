                ...
                <div class="row" style="min-height:500px">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <form name="form1" action="" mmethod="post" class="col-lg-6" enctype="multipart/form-data">
                                 <table class="table table-bordered">
                                <tr>
                                    <td><input type="text" class="form-control"   placeholder="booksname" required=""></td>
                                </tr>
                                <tr>
                                    <td><input type="file"  class="form-control" name="f1" required=""></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td><input type="text"  class="form-control" placeholder="books purchase dtae " name="bpurchasedt" required=""></td>
                                </tr>
                                <tr>
